...
int main()
{
  ...
  printf("Sending a grease ech to get the retry configs back...\n");
...
/* The ECH client that connects to cloudflare servers */
...
#define CERT_FILE "examples/benchmark/certs-cloudflare.pem"
//#define CERT_FILE "certs/wolfssl-website-ca.pem"
//#define CERT_FILE "examples/benchmark/certs-defo.pem"
//#define CERT_CA_FILE "examples/benchmark/cert_ca.pem"
//#define CERT_CHAIN_FILE "examples/benchmark/cert_chain.pem"
...
/* The local ECH client and local ECH server that connects to each other */
